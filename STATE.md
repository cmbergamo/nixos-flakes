...
| server/base.nix | Módulo base headless do servidor: tuning de memória (zram zstd 50%, earlyoom), sysctl de rede, GC do nix, systemd-networkd com DHCP em en*/eth*, resolved com fallback DNS 1.1.1.1/8.8.8.8, OpenSSH porta 22, fail2ban, Podman e pacotes essenciais | networkd exige .network configurado para DHCP em en*/eth*, caso contrário interfaces ficam sem IP; wait-online.anyInterface evita hang de boot em portas desconectadas |
